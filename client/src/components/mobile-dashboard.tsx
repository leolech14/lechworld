                      ...
                      {member.programs.map((program) => (
                        ...
                        >
                          ...
                          <p className="text-xs font-medium text-gray-700">
                            {program.program.name.replace(' Pass', '').replace('Gol ', '')}
                          </p>
                          <p className="text-xs text-gray-500">
                            {program.pointsBalance?.toLocaleString() || '0'} pts
                          </p>
                        </div>
                      ))}
                    </div>
                      ...
                      {member.programs.slice(0, 4).map((program) => (
                        ...
                        >
                          ...
                          <p className="text-sm font-bold text-gray-800">
                            {program.pointsBalance?.toLocaleString() || '0'}
                          </p>
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800">
                          {members.reduce((acc, member) => {
                            const programData = member.programs.find(p => p.program.name === program);
                            return acc + (programData?.pointsBalance || 0);
                          }, 0).toLocaleString()}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-800">
                          {members.filter(member => 
                            member.programs.some(p => p.program.name === program)
                          ).length}
                        </p>
                      </div>
                    </div>
